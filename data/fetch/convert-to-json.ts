...
const stripHtml = (input: string) => {
  ...
  // [\s\S] rather than the `s` (dotAll) flag, which needs ES2018 — this project
  // targets ES2017. Semantically identical, and matches the idiom used below.
  processedInput = processedInput.replace(/<a[^>]*>([\s\S]*?)<\/a>/gi, '$1');
